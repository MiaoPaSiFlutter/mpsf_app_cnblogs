...
class MpsfNewsItemsScreen extends StatefulWidget {
  final String initialUrl;
  final String htmlString;
  MpsfNewsItemsScreen({Key key, this.initialUrl, this.htmlString})
      : super(key: key);
...
class _MpsfBlogDetailScreenState extends State<MpsfNewsItemsScreen>
